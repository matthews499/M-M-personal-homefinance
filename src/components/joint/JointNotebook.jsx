...
import { useJointNotebook } from '../../hooks/useJointNotebook'
...
export default function JointNotebook() {
  const { entries, loading, create, update, remove } = useJointNotebook()
    ...
    <>
      <div className="rounded-2xl p-5 space-y-4" style={cardStyle}>
        <div className="flex items-center justify-between">
          <SectionLabel>Joint notebook</SectionLabel>
          <button
